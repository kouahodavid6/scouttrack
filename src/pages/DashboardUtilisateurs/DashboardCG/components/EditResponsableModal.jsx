...
import RegistrationFormResponsable from "./RegistrationFormResponsable";

const EditResponsableModal = ({ isOpen, onClose, initialData, onSubmit }) => {
    ...
    return (
        ...
        >
            ...
            >
                {/* En-tête avec icône de modification */}
                <header className="p-5 border-b border-gray-100 bg-gradient-to-r from-violet-50 to-white flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-xl font-semibold text-gray-800">Modifier le responsable</h2>
                    </div>
                    <button
                        onClick={onClose}
                ...
                {/* Contenu avec effet de scroll doux */}
                <section className="p-6 overflow-y-auto flex-1 scroll-smooth">
                    <RegistrationFormResponsable
                        onSubmit={onSubmit}
